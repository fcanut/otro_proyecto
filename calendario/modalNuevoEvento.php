<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <form name="formEvento" id="formEvento" action="nuevoEvento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      <label for="fecha_evento" class="col-sm-12 control-label">Fecha Inicio</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="fecha_evento" id="fecha_evento" placeholder="Fecha Evento">
      </div>
    </div>
